...
class _GestDataPageState extends State<GestDataPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _linkFinal(
            'VER RESUMEN EN PANTALLA', ico: Icons.reset_tv_rounded,
            fnc: () async {
  ...
  Widget _linkFinal(String label, {required Function fnc, required IconData ico}) {
    ...
    return TextButton.icon(
      ...
      icon: Icon(ico, color: _globals.colorGreen),
      label: Text(
        label,
        textScaleFactor: 1,
        style: TextStyle(
  ...
  Future<void> _salirCot() async {
    ...
    ShowDialogs.alert(
      context, 'exitCot',
      hasActions: true, labelNot: 'NO. Continuar', labelOk: 'SÍ, Salir'
    ).then((res) {
